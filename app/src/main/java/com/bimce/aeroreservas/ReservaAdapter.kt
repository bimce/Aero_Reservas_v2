...
class ReservaAdapter(private val reservahistorial: List<Reservahistorial>?) : RecyclerView.Adapter<ReservaAdapter.ReservaViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ReservaViewHolder, position: Int) {
        val reserva = reservahistorial?.get(position)
    ...
    override fun getItemCount(): Int {
        return reservahistorial?.size ?: 0
    }
}
